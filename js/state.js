...
async function BatchScript_InsertSmartStreamExample2() {
  ...
  insertSmartStream(app, tab, {
    ...
    endType: 'DataDataEntity',
    levels: null,
    showTypes: ['GeneralActor', 'BusinessService', 'BusinessCapability', 'BusinessProcess', 'ApplicationService', 'ApplicationCapability', 'ApplicationProcess', 'ApplicationLogicalComponent', 'ApplicationPhysicalComponent', 'DataDataEntity', 'BusinessFunction', 'BusinessOrganizationUnit', 'ApplicationApplication'],
  });
...
class Store {
  ...
  constructor(settings, industryTree, nodeSizeMultiplier = 1.2) {
    ...
    this.doc = {
      ...
      views: [
        { id: 'home', viewName: 'home', viewType: 'ff', note: '', chkShowConnectorType: true, chkShowStreamType: false, chkShowDataType: true, chkShowOnlyDerived: false, chkShowKeys: false, chkShowElementTypes: true, chkShowDescription: true, chkShowAttributes: true, chkShowOnPageCatalogs: false, chkShowSimValues: false, chkShowScriptBadge: false, chkShowAllText: false, routingStyle: 'default', routingStyleStream: 'default', margin: 50, sections: [], ...defaultNodeSize(nodeSizeMultiplier), remapSortKeys: null, remapLastOptions: null, spacingScale: 1, spacingAxis: 'both' },
      ],
      parts: [],
      connectors: [],
      viewMembers: [],
  ...
  addView(viewName, viewType = 'ff') {
    ...
    const view = { id, viewName, viewType, note: '', chkShowConnectorType: true, chkShowStreamType: false, chkShowDataType: true, chkShowOnlyDerived: false, chkShowKeys: false, chkShowElementTypes: true, chkShowDescription: true, chkShowAttributes: true, chkShowOnPageCatalogs: false, chkShowSimValues: false, chkShowScriptBadge: false, chkShowAllText: false, routingStyle: 'default', routingStyleStream: 'default', margin: 50, sections: [], ...defaultNodeSize(this.nodeSizeMultiplier), remapSortKeys: null, remapLastOptions: null, spacingScale: 1, spacingAxis: 'both' };
...
function migrateDoc(obj, nodeSizeMultiplier = 1.2) {
  const doc = {
    ...
    views: obj.views && obj.views.length ? obj.views.map((v) => ({ ...v, viewType: v.viewType || 'ff', note: v.note ?? '', sections: v.sections ?? [], nodeWidth: v.nodeWidth ?? defaultNodeSize(nodeSizeMultiplier).nodeWidth, nodeHeight: v.nodeHeight ?? defaultNodeSize(nodeSizeMultiplier).nodeHeight, remapSortKeys: v.remapSortKeys ?? null, remapLastOptions: v.remapLastOptions ?? null, chkShowConnectorType: v.chkShowConnectorType ?? (v.chkShowConnectors ?? true), chkShowStreamType: v.chkShowStreamType ?? (v.chkShowConnectors ?? true), chkShowDataType: v.chkShowDataType ?? true, chkShowOnlyDerived: v.chkShowOnlyDerived ?? false, chkShowDescription: v.chkShowDescription ?? true, chkShowAttributes: v.chkShowAttributes ?? true, chkShowSimValues: v.chkShowSimValues ?? false, chkShowScriptBadge: v.chkShowScriptBadge ?? false, chkShowAllText: v.chkShowAllText ?? false, routingStyle: v.routingStyle ?? 'default', routingStyleStream: v.routingStyleStream ?? 'default', spacingScale: v.spacingScale ?? 1, spacingAxis: v.spacingAxis ?? 'both' })) : [{ id: 'home', viewName: 'home', viewType: 'ff', note: '', chkShowConnectorType: true, chkShowStreamType: false, chkShowDataType: true, chkShowOnlyDerived: false, chkShowKeys: false, chkShowElementTypes: true, chkShowDescription: true, chkShowAttributes: true, chkShowOnPageCatalogs: false, chkShowSimValues: false, chkShowScriptBadge: false, chkShowAllText: false, routingStyle: 'default', routingStyleStream: 'default', margin: 50, sections: [], ...defaultNodeSize(nodeSizeMultiplier), remapSortKeys: null, remapLastOptions: null, spacingScale: 1, spacingAxis: 'both' }],
