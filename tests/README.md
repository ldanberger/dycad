...
| `check_sfce_catalog_page` | The SFCCE Catalog page failing to open, or missing rows/columns for the Section/Function/Capability/Sub-Capability/Entity hierarchy |
